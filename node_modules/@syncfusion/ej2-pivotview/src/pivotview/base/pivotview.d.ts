...
export declare class PivotView extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    /** @hidden */
    applyRowSelection(colIndex: number, rowIndex: number): void;
    /** @hidden */
    applyColumnSelection(e: MouseEvent | KeyboardEventArgs, target: Element, colStart: number, colEnd: number, rowStart: number): PivotCellSelectedEventArgs;
