...
import { BorderModel, ErrorBarSettingsModel, MarkerSettingsModel, ChartDrawType } from '@syncfusion/ej2-charts';
import { TrendlineModel, LegendShape, SplineType, EmptyPointSettingsModel } from '@syncfusion/ej2-charts';
import { AnimationModel, ChartSegmentModel, Segment, FontModel } from '@syncfusion/ej2-charts';
import { EdgeLabelPlacement, LabelPlacement, AxisPosition, MajorTickLinesModel, MinorTickLinesModel } from '@syncfusion/ej2-charts';
import { MinorGridLinesModel, AxisLineModel, LabelBorderModel, MarginModel } from '@syncfusion/ej2-charts';
import { ChartAreaModel, ChartTheme, LegendSettingsModel, IndexesModel } from '@syncfusion/ej2-charts';
import { IResizeEventArgs, IPrintEventArgs, ILoadedEventArgs, ILegendRenderEventArgs } from '@syncfusion/ej2-charts';
...
import { LabelIntersectAction, ZoomMode, ToolbarItems } from '@syncfusion/ej2-charts';
import { CornerRadiusModel, MajorGridLinesModel, StripLineSettingsModel } from '@syncfusion/ej2-charts';
import { IAnimationCompleteEventArgs, IAxisLabelRenderEventArgs, IZoomCompleteEventArgs } from '@syncfusion/ej2-charts';
import { CrosshairTooltipModel } from '@syncfusion/ej2-charts';
import { CrosshairSettingsModel } from '@syncfusion/ej2-charts';
