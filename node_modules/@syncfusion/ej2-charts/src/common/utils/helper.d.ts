...
import { Rect, TextOption, Size, PathOption, SvgRenderer } from '@syncfusion/ej2-svg-base';
/**
 ...
 * @param isReplace
 */
export declare function appendChildElement(parent: Element | HTMLElement, childElement: Element | HTMLElement, redraw?: boolean, isAnimate?: boolean, x?: string, y?: string, start?: ChartLocation, direction?: string, forceAnimate?: boolean, isRect?: boolean, previousRect?: Rect, animateduration?: number): void;
/** @private */
...
/** @private */
export declare function textElement(option: TextOption, font: FontModel, color: string, parent: HTMLElement | Element, isMinus?: boolean, redraw?: boolean, isAnimate?: boolean, forceAnimate?: boolean, animateduration?: number): Element;
/**
