@include export-module('card-layout') {
  ...
  .e-bigger.e-card {
    ...
    > .e-card-header-title {
      ...
      @if $card-skin-name == 'fabric' or $card-skin-name == 'bootstrap' or $card-skin-name == 'highcontrast' {
        min-height: 45px;
      }
  ...
  .e-card {
    ...
    width: 100%;
    @if $card-skin-name == 'fabric' or $card-skin-name == 'highcontrast' {
      padding: 1px;
    }
    ...
    .e-card-header {
      ...
      .e-card-header-image  {
        align-self: center;
        display: flex;
        @if $card-skin-name == 'highcontrast' {
          border: 1px solid;
        }
      }
