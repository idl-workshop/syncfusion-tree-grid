...
.e-bigger .e-lib.e-popup.e-ddl-device .e-input-group {
  margin: 0 0 0 55px;
}
...
.e-query-builder .e-btn-group input + label.e-btn, .e-query-builder .e-group-action .e-btn, .e-query-builder .e-removerule.e-btn.e-round, .e-query-builder .e-removerule.e-btn.e-round:hover {
  background: #fff;
  border-color: #dee2e6;
  color: #495057;
}
