...
import { CellSelectEventArgs, CellSelectingEventArgs, CellEditArgs, ContextMenuItemModel } from '@syncfusion/ej2-grids';
...
export declare class Gantt extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     * @public
     */
    expandByID(id: string | number): void;
    /**
     ...
     * @public
     */
    collapseByID(id: string | number): void;
    /**
     ...
     * @public
     */
    addPredecessor(id: String | number, predecessorString: string): void;
    /**
     ...
     * @public
     */
    removePredecessor(id: String | number): void;
    /**
     ...
     * @public
     */
    updatePredecessor(id: String | number, predecessorString: string): void;
    /**
     ...
     * @return {void}
     */
    selectCells(cellIndex: IIndex, isToggle?: boolean): void;
}
