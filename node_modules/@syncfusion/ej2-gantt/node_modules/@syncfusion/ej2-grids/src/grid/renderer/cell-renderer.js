...
var CellRenderer = /** @class */ (function () {
    ...
    CellRenderer.prototype.evaluate = function (node, cell, data, attributes, fData, isEdit) {
        ...
        if (cell.column.template) {
            ...
            if (isBlazor() && isEdit) {
                ...
                result = cell.column.getColumnTemplate()(extend({ 'index': attributes[literals[0]] }, dummyData), this.parent, 'template', templateID);
            }
     ...
     * @param  {Element}
     */
    CellRenderer.prototype.render = function (cell, data, attributes, isEdit) {
